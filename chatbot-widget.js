...
function startConversation() {
    fetch('https://chatbot-for-vistaar-montessori-school.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-vistaar-montessori-school.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbw8bQNV6yS8hAicTGGIveWLFx7tZJLlSdo2Kr4oV-5Jd5MQpQiPNVfygHl7T2urZfWOkw/exec';
